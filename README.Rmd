...
The `auto_delin()` function will load the python module [face_recognition](https://github.com/ageitgey/face_recognition). If you get errors about that, you may need to install cmake and dlib first. I found these instructions useful for [dlib installation on a mac](https://stackoverflow.com/questions/54719496/how-to-install-dlib-for-python-on-mac).
